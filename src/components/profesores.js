...
class TablesAbono extends PureComponent {
    constructor(props)
  {
    super(props)
...
*/
 ...
 this.setState({listBusquedaProfesor:this.state.listProfesor,loading:false});
          ...
          <Row>
            <Col md="12">
              ...
              <Card>
                ...
                return(
                  <tr>
                    <td key={data.i}>{data.legajo}</td>
                    <td key={data.i}>{data.nombre}</td>
                    <td key={data.i}  >{data.apellido}</td>
